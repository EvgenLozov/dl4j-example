...
public class AnimalsClassificationOrigin {
    protected static final Logger log = LoggerFactory.getLogger(AnimalsClassificationOrigin.class);
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
    ...
    public static void main(String[] args) throws Exception {
        new AnimalsClassificationOrigin().run(args);
    }
